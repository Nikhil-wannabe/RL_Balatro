...
where each trajectory `tau_i` is sampled from the draw process induced by the current remaining deck.
...
where:
- `Q_0.2` is the lower 20th percentile of rollout utility,
